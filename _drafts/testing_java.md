...
### Integration Tests
All non-trivial applications will integrate with some other parts at some point. Think about databases, filesystems, network, and other services in your microservices landscape. Typically these are the kind of things you leave out when writing your unit tests. Still, your real application will interact with these other parts and therefore you need to test these interactions in order to prove that they are working. These _integration tests_ check the integration of your application under test with all the parts that live outside of your application.
